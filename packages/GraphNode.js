...
export default class GraphNode {
  ...
  get position() {
    if (this.coordinate[0] <= 0 - this.graph.origin[0]) { // 限制移出画布
      this.coordinate[0] = 0 - this.graph.origin[0]
    } else if (this.coordinate[0] >= this.graph.flowCanvasInfo.width - this.graph.nodeList[0].width - this.graph.origin[0]) {
      this.coordinate[0] = this.graph.flowCanvasInfo.width - this.graph.nodeList[0].width - this.graph.origin[0]
    }
    if (this.coordinate[1] < 0 - this.graph.origin[1]) { // 限制移出画布
      this.coordinate[1] = 0 - this.graph.origin[1]
    } else if (this.coordinate[1] >= this.graph.flowCanvasInfo.height - this.graph.nodeList[0].height - this.graph.origin[1]) {
      this.coordinate[1] = this.graph.flowCanvasInfo.height - this.graph.nodeList[0].height - this.graph.origin[1]
    }
